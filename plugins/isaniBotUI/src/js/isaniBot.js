...
IsaniBot.prototype.addEventRegPanel = function() {
  //self.cleanRegPanel();
  BdApi.injectCSS('eventRegpanelCSS',
      '.bot-event-reg-icon { margin-right: 6px;}' +
      ...
      '.bot-event-reg-panel-content { width: 365px; height: auto; }' +
      '.margin10 { margin-top: 10px; margin-bottom: 10px; }' +
      '.theme-dark { color: #fff; font-size: 15px }' +
      '.theme-light { color: #4f545c!; font-size: 15px }' +
      '.event-textarea { border: none; padding: 4px 5px }' +
